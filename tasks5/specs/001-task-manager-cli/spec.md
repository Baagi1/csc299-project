...
- **FR-005**: Tasks MUST be persisted to a local JSON file (default location: `~/.task_manager/tasks.json`), and the path MUST be configurable via an environment variable or CLI flag for tests.
